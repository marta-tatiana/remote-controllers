...
window.onload = (event) => {
  ...
  document.getElementById('up').addEventListener('click', up1, false);
  document.getElementById('down').addEventListener('click', down1, false);
  document.getElementById('left').addEventListener('click', left1, false);
